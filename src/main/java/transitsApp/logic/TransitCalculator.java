...
public class TransitCalculator {
    ...
    private TransitInfoProvider provider;

    @Autowired
    public TransitCalculator(TransitRepository transitRepo, TransitInfoProvider provider) {
    ...
    public void calculateTransit(Transit transit) {
        ...
        int distanceMetres = provider.getDistance(source, destination);
        double time = provider.getTime(source, destination);
